--DROP DATABASE "TestEntity";

/*CREATE DATABASE "TestEntity" WITH OWNER = postgres ENCODING = 'UTF8' LC_COLLATE = 'Russian_Russia.1251' LC_CTYPE = 'Russian_Russia.1251' TABLESPACE = pg_default CONNECTION
LIMIT
    = -1;*/
...
ALTER TABLE
    public."RoleClaims" OWNER to postgres;
...
ALTER TABLE
    public."UserTokens" OWNER to postgres;
...
ALTER TABLE
    public."UserLogins" OWNER to postgres;
...
ALTER TABLE
    public."UserClaims" OWNER to postgres;
...
ALTER TABLE
    public."Operators" OWNER to postgres;
...
ALTER TABLE
    public."Sports" OWNER to postgres;
...
ALTER TABLE
    public."Teams" OWNER to postgres;
...
ALTER TABLE
    public."TypeOfBets" OWNER to postgres;
...
ALTER TABLE
    public."PossibleBets" OWNER to postgres;
...
ALTER TABLE
    public."UserBets" OWNER to postgres;
...
ALTER TABLE
    public."MoneyManagement" OWNER to postgres;